...
/////////////////////////////////////////////////////////////////////////////
if (resbutton == `MENU GRUP`){
if (!isRegistered) return reply(ind.noregis())
if (isBanned) return reply(ind.ban())
reply(menu.grup(f, prefix))
} else if (resbutton == `ABOUT BANK`){
if (!isRegistered) return reply(ind.noregis())
if (isBanned) return reply(ind.ban())
reply(menu.bank(f, prefix))
} else if (resbutton == `MENU ASUPAN`){
if (!isRegistered) return reply(ind.noregis())
if (isBanned) return reply(ind.ban())
reply(menu.asupan(f, prefix))
} else if (resbutton == `MENU SEARCH`){
if (!isRegistered) return reply(ind.noregis())
if (isBanned) return reply(ind.ban())
reply(menu.search(f, prefix))
} else if (resbutton == `MENU EDITING`){
if (!isRegistered) return reply(ind.noregis())
if (isBanned) return reply(ind.ban())
reply(menu.editing(f, prefix))
} else if (resbutton == `MENU OWNER`){
if (!isRegistered) return reply(ind.noregis())
if (isBanned) return reply(ind.ban())
reply(menu.owner(f, prefix))
} else if (resbutton == `MENU STORAGE`){
if (!isRegistered) return reply(ind.noregis())
if (isBanned) return reply(ind.ban())
reply(menu.storage(f, prefix))
} else if (resbutton == `MENU DOWNLOADER`){
if (!isRegistered) return reply(ind.noregis())
if (isBanned) return reply(ind.ban())
reply(menu.downloader(f, prefix))
} else if (resbutton == `MENU STALK`){
if (!isRegistered) return reply(ind.noregis())
if (isBanned) return reply(ind.ban())
reply(menu.stalk(f, prefix))
} else if (resbutton == `MENU OTHER`){
if (!isRegistered) return reply(ind.noregis())
if (isBanned) return reply(ind.ban())
reply(menu.other(f, prefix))
} else if (resbutton == `MENU FUN`){
if (!isRegistered) return reply(ind.noregis())
if (isBanned) return reply(ind.ban())
reply(menu.fun(f, prefix))
} else if (resbutton == `MENU GABUT`){
if (!isRegistered) return reply(ind.noregis())
if (isBanned) return reply(ind.ban())
reply(menu.gabut(f, prefix))
} else if (resbutton == `MENU CONVERT`){
if (!isRegistered) return reply(ind.noregis())
if (isBanned) return reply(ind.ban())
reply(menu.convert(f, prefix))
} else if (resbutton == `MENU STICKER`){
if (!isRegistered) return reply(ind.noregis())
if (isBanned) return reply(ind.ban())
reply(menu.sticker(f, prefix))
} else if (resbutton == `RANDOM IMAGE`){
if (!isRegistered) return reply(ind.noregis())
if (isBanned) return reply(ind.ban())
reply(menu.randomimage(f, prefix))
} else if (resbutton == ` INFO BOT `){
if (!isRegistered) return reply(ind.noregis())
if (isBanned) return reply(ind.ban())
...
*┃┃*${prefix}menu
*┃┃*${prefix}jadian
*┃┃*${prefix}afk lalu tuliskan alasan
*┃┣•「 𝗔𝗕𝗢𝗨𝗧 」*
*┃┃*${prefix}infobot
*┃┃*${prefix}sewa
*┃┃*${prefix}speed
