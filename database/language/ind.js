...
exports.iklan1 = () => {
 return` IKLAN MASIH KOSONG HEHE `
}
exports.iklan2 = () => {
 return` IKLAN MASIH KOSONG HEHE `
}
...
KETIK *#DAFTAR NAMA | UMUR* UNTUK MENDAFTARKAN DIRI KE DALAM DATABSE BOT`
}

exports.rediregis = () => {
	return`\`\`\`KAMU SUDAH PERNAH MELAKUKAN PENDAFTARAN SEBELUMNYA!\`\`\``
}
exports.ban = () => {
...
exports.ison = () => {
     return `*FITUR TERSEBUT SUDAH PERNAH DI AKTIFKAN SEBELUMNYA!*`
}
...
exports.premb = () => {
     return`MAAF FITUR TERSEBUT HANYA BISA DI GUNAKAN OLEH USER PREMIUM, INGIN MENJADI USER PREMIUM BISA HUBUNGI #OWNER`
}
exports.clears = () => {
	return`\`\`\`CLEAR ALL SUCCES\`\`\``
}
exports.udhmati = (command) => {
    return `*FITUR ${command} BELUM PRENAH DI AKTIFKAN!*`
}
exports.succeson = (command) => {
      return `*──❮ SUKSES ❯──*\n\n_FITUR ${command} BERHASIL DI AKTIFKAN!_`
}
exports.succesoff = (command) => {
